...
# -------------- help
        ...
        if data.find(username + '!') == -1:
            ...
            irc.send('PRIVMSG ' + who + ' :|    en = english | fa = persian    |\r\n')
            irc.send('PRIVMSG ' + who + ' :| .enfa phrase ~> English to Farsi  |\r\n')
            irc.send('PRIVMSG ' + who + ' :| .faen phrase ~> Farsi to German   |\r\n')
            irc.send('PRIVMSG ' + who + ' :| .defa phrase ~> German to Turkish |\r\n')
        ...
        if data.find(':.') != -1:
            ...
            try:
                if lang == ".w":
                    ...
                    lt = lang[1:3]
                    lf = lang[-2:]
                    irc.send('PRIVMSG ' + channel + ' :' + who + ', ' + Translator().translate(ebarat, lf, lt) + '\r\n')
                    print Translator().translate(ebarat, lf, lt)
